...
public class Home extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jDesktopPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 0, 960, 730));
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 300, 730));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/backOk.png"))); // NOI18N
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 0, 960, 730));
        ...
        LaporanMobil.setText("Laporan Mobil");
    ...
    private void LaporanMobilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LaporanMobilActionPerformed
       jDesktopPane1.setVisible(true);
        jDesktopPane1.removeAll();
        jDesktopPane1.repaint();
        Laporan_Mobil lm = new Laporan_Mobil();
        lm.setVisible(true);
    ...
    private void LaporanTransaksiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LaporanTransaksiActionPerformed
        ...
        jDesktopPane1.removeAll();
        jDesktopPane1.repaint();
        Laporan_Peminjam lp = new Laporan_Peminjam();
        lp.setVisible(true);
    ...
    private void TransaksiMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TransaksiMouseClicked
        ...
        jDesktopPane1.removeAll();
        jDesktopPane1.repaint();
        Form_Peminjam ft = new Form_Peminjam();
        ft.setVisible(true);
